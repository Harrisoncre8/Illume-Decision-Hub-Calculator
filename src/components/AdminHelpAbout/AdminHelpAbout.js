                ...
                <h1 className="main-heading admin-industry-heading">Help</h1> 
                    ...
                    <h2>Edit Calculator Text</h2><br/>
                        <p>
                            ...
                            mark is hovered over. Edit each as you would like and hit save. 
                        </p>
                        <br/>
                        <br/>
                    <h2>User Profile Changes</h2><br/>
                        <p>
                            ...
                            Here, admins are able to edit any of the client information. Leaving the 'password' and 'confirm password'
                    ...
                    <h2>Industry Changes</h2><br/>
                        <p>
                            ...
                            If a user with a disabled industry logs in, they will be prompted to choose a new industry before being 
                            able to use the application. Alternatively, admins edit individual user's industries in the 'Edit User 
                            Information' tab. 
                        </p>
            </div>
        </div>
